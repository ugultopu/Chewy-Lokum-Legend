...
public class CopyOfBoardLogic {

	private LogicField[][] logicFields;
	private int rowSize;
	private int columnSize;
	private PriorityQueue<Combo> boardCombos;
	private static CopyOfBoardLogic instance;


	/*
	 * CHECK!
	 */
	public static CopyOfBoardLogic getInstance(){
		if(instance == null)
			instance = new CopyOfBoardLogic();
		return instance;
	}
	...
	public static void loadBoard(LogicField[][] logicFields){
		instance = new CopyOfBoardLogic(logicFields);
	}
	...
	private CopyOfBoardLogic(){
		...
		boardCombos = new PriorityQueue<Combo>();
	 ...
	 */
	private CopyOfBoardLogic(LogicField[][] logicFields){
		this.rowSize = Constants.BOARD_WIDTH;
		this.columnSize = Constants.BOARD_HEIGHT;
